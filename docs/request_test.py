...
mhurl = 'http://localhost:8080/api/medicalHistories/'
mhdata = {
    "patientId": "1",
...
# resp = requests.get(hellourl, data=json.dumps(admindata), headers=header)
...
resp = requests.post(mhurl, data=json.dumps(mhdata), headers=header)
