...
public class ReadingController {
    ...
    public @ResponseBody String addAReading(@RequestParam String reader_id,
                                            ...
                                            @RequestParam String other_symptoms, @RequestParam int systolic_bp,
                                            @RequestParam int diastolic_bp, @RequestParam int pulse_rate,
                                            @RequestParam String notes, @RequestParam boolean need_followup){
        //TODO: not sure about arguments for symptoms
        //TODO: add stuff here + maybe get current date/time for timestamp? - already imported the util for you, Jovan :)
