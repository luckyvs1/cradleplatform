...
public enum VitalsTrafficLight {
	...
	Yellow_up("Raised BP",
			...
			"This is raised BP this patient may have preeclapsia. \n Action is needed. \n Manage" +
					...
					"visual disturbance) and act accordingly. \n If in the community transfer when practical " +
	...
	Red_down("In sever shock",
			...
			"Community Version \n * Stay calm. Do NOT leave the woman alone \n * Get HELP \n * Assess the " +
					...
					"of placenta, give medication to contract uterus if available e.g. misoprostil 600mcg orally \n * If sepsis," +
					" consider starting antibiotics \n Hospital Version \n * Stay calm. Do NOT leave the woman alone \n * Get " +
					"HELP \n * Assess the mother \n * Is she pale, sweaty, cold, breathing fast, drowsy or confused? \n" +
					"* Is she unwell e.g. vaginal bleeding, fever, discharge, constant pain? \n Treatment \n * Keep her warm " +
					"and elevate legs if possible \n * Oxygen \n * IV fluids give quickly through a large bore cannula e.g. 2 " +
					"litres in first hour \n * Collect blood to test hemoglobin, do an immediate cross-match \n * Catheterise " +
					"the bladder to monitor input/output \n * Decide on the cause of shock and manage as you would normally \n " +
