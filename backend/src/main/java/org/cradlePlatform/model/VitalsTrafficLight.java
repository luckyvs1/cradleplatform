...
public enum VitalsTrafficLight {
    ...
    Yellow_down("Low BP",
            ...
            new String[]{"* Resuscitate as necessary e.g. keep warm, elevate legs",
    ...
    Red_down("In severe shock",
            "Urgent action needed. Get help and assess mother. Immediately transfer to health centre (max 1h).",
            null,
            "Shock Index (HR/Systolic BP) is >= 1.7",
            null,
            new String[]{"* Stay calm. Do NOT leave the woman alone", "* Get HELP", "* Assess the mother", "* Is she " +
					"pale, sweaty, cold, breathing fast, drowsy or confused?", "* Is she unwell e.g. vaginal bleeding, " +
					"fever, discharge, constant pain?"},
            new String[]{"* Keep her warm and elevate legs if " +
            ...
            new String[]{"* Stay calm. Do NOT leave the woman alone", "* Get HELP", "* Assess the mother",
                    "* Is she pale, sweaty, cold, breathing fast, drowsy or confused?", "* Is she unwell e.g. vaginal " +
                    "bleeding, fever, discharge, constant pain?"},
            new String[]{"* Keep her warm and elevate legs if possible", "* Oxygen", "* IV fluids give quickly through " +
					"a large bore cannula e.g. 2 litres in first hour", "* Collect blood to test hemoglobin, do an " +
					"immediate cross-match", "* Catheterise the bladder to monitor input/output", "* Decide on the " +
					"cause of shock and manage as you would normally", "* If bleeding transfuse blood, give uterotonics " +
					"such as IV oxytocin, misoprostil or carboprost", "* Consider operative interventions if appropriate" +
					" and available", "* If severe infection, keep hydrated, give IV antibiotics"});
    ...
    VitalsTrafficLight(String analysisText, String briefAdviceText, String adviceText, String conditionText,
					   String[] adviceDetailsText, String[] communityAdviceText, String[] communityTreatmentText,
					   String[] hospitalAdviceText, String[] hospitalTreatmentText) {
